...
public class AdminSettingsActivity extends PreferenceActivity {
	 ...
	 * wird der nÃ¤chste Alarm gesetzt
	 */
	@Override
	...
	/**
	 * @brief ÃœberprÃ¼ft, ob eine File existiert und ob etwas in der Datenbank liegt
	 * @return
	 * Codes: 
	 * <ul>
	...
	/**
	 * @brief Sollte es zu problemen beim Export kommen, kann die Datenbank fï¿½r manuellen export kopiert werden.
	 */
