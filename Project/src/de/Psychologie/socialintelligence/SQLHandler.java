...
public class SQLHandler extends SQLiteOpenHelper {
	...
	/**
	 * @brief Beim Erh�hen der DATABASE_VERSION Version, alles wird gel�scht
...
//	}
	...
	/**
	 * @brief Zur Optimierung k�nnen alle Zeitslots mit einem Datenbankzugriff gespeicher werden
	 * @param DayTime HashMap<Day als Integer,Zeiten als String-Array>
	 */
	public void addAllDayTime(HashMap<Integer,String[]> DayTime){
		// SQLite unterst�tzt keine Multi-Insert, aber einen Insert mit Select.
        ...
        for(Map.Entry<Integer,String[]> e : DayTime.entrySet()){
        	for(int i=0;i<e.getValue().length;i++){
        		// Werte einf�gen, Tag und Zeit
            	value[entry++] = "SELECT '"+e.getKey().toString()+"', '"+e.getValue()[i]+":00'";
        	}
        }
        
        // SQL-Query erweitern um alle eingef�gten Werte,
        // diese werden mit UNION miteinander verkn�pft.
	...
	/**
	 * @brief Alle Zeitslots aus der Datenbank l�schen
	 */
