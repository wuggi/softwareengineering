...
public class Week extends Activity {
	...
	private void disableRow1() {
		...
		// die neue Methode ist zwar veraltet, aber so kï¿½nnen auch alte
		// Gerï¿½te
		// es nutzen
		...
		if (cur != null) {
			if (cur.moveToFirst()) {
				do {
					...
					// Zeitslots setzen, alle Buttons werden ï¿½bergeben
